...
<body>
    ...
    <div id="content">      
        <p id="tytul"> Co chcesz dodać? </p> 
        <button type="button" onclick="window.location.href='dodaj_k.php'" class="select">Komputery</Button>
        <button type="button" onclick="window.location.href='dodaj_p.php'" class="select">Peryferia</Button>
        <button type="button" onclick="window.location.href='dodaj_l.php'" class="select">Sieci LAN</Button>
        <button type="button" onclick="window.location.href='dodaj_s.php'" class="select">Szkoły</Button>
    </div>
    <footer>
        <div id="uzytkownik">
            <p>
