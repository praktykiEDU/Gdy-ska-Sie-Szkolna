            ...
            <option selected hidden></option>
                ...
                <script>
                    function update(select) {
                        ...
                        "</h1><table id='output'><tr><th>Nazwa użytkownika</th><td><form action='../Strona/update/nazwa_uzytkownika_u.php' method='POST'><input type='hidden' name='id' value='" + id + 
                        "' readonly> <input type='text' name='nazwa_uzytkownika'> <button type='submit'>Zaktualizuj</button></form></td></tr><tr><th>Hasło</th><td><form action='../Strona/update/haslo_u.php' method='POST'><input type='hidden' name='id' value='" + id + 
                        "' readonly> <input type='text' name='haslo'> <button type='submit'>Zaktualizuj</button></form></td></tr><tr><th>E-Mail</th><td><form action='../Strona/update/email_u.php' method='POST'><input type='hidden' name='id' value='" + id + 
                        "' readonly> <input type='text' name='email'> <button type='submit'>Zaktualizuj</button></form></td></tr><tr><th>ID szkoły</th><td><form action='../Strona/update/szkola_id_u.php' method='POST'><input type='hidden' name='id' value='" + id + 
                        "' readonly> <input type='text' name='szkola_id'> <button type='submit'>Zaktualizuj</button></form></td></tr><tr><th>Szkoła</th><td><form action='../Strona/update/szkola_u.php' method='POST'><input type='hidden' name='id' value='" + id + 
                        "' readonly> <input type='text' name='szkola'> <button type='submit'>Zaktualizuj</button></form></td></tr><tr><th>Admin</th><td><form action='../Strona/update/admin_u.php' method='POST'><input type='hidden' name='id' value='" + id + 
                        "' readonly> <input type='text' name='admin'> <button type='submit'>Zaktualizuj</button></form></td></tr><tr><th>Super admin</th><td><form action='../Strona/update/super_admin_u.php' method='POST'><input type='hidden' name='id' value='" + id + 
