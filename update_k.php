            ...
            <?php
                ...
                <script>
                    function update(select) {
                        ...
                        "' readonly> <input type='date' name='data_zakupu_monitora'> <button type='submit'>Zaktualizuj</button></form></td></tr><tr><th>Gwarancja monitora</th><td><form action='../Gdynska-Siec-Szkolna-main/update/gwarancja_monitora_k.php' method='POST'><input type='hidden' name='id' value='" + id +
                        "' readonly> <input type='date' name='gwarancja_monitora'> <button type='submit'>Zaktualizuj</button></form></td></tr><tr><th>Numer inwentarzowy monitora</th><td><form action='../Gdynska-Siec-Szkolna-main/update/numer_inwentarzowy_monitora_k.php' method='POST'><input type='hidden' name='id' value='" + id +
