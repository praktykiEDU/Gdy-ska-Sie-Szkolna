...
<body>
    ...
    <div id="content">
        <p id="tytul"> Co chcesz zobaczyć? </p> 
        <button type="button" onclick="window.location.href='komputery.php'" class="select">Komputery</button>
        <button type="button" onclick="window.location.href='peryferia.php'" class="select">Peryferia</button>
        <button type="button" onclick="window.location.href='sieci_lan.php'" class="select">Sieci LAN</button>
        <button type="button" onclick="window.location.href='szkoly.php'" class="select">Szkoły</button>
    </div>
    <footer>
        <div id="uzytkownik">
            <p>
