...
<body>
    ...
    <div id="content">
        ...
        <button type="button" onclick="window.location.href='uzytkownicy.php'" class="select">Lista<br>użytkowników</button>
        <button type="button" onclick="window.location.href='uprawnienia.php'" class="select">Zarządzaj uprawnieniami</button>
    </div>
    <footer>
        <div id="uzytkownik">
            <p>
