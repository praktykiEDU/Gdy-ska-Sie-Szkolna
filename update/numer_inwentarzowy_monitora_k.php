<?php
        ...
        $numer_inwentarzowy_monitora = $_POST['numer_inwentarzowy_monitora'];
        $ID = $_POST['id'];
        $sql = "UPDATE komputery SET Numer_inwentarzowy_monitora='$numer_inwentarzowy_monitora' WHERE ID='$ID'";
