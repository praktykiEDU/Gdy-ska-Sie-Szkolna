...
<body>
    ...
    <div id="content">
        ...
        ?>
            <tr>
                <th>ID</th> <th>ID szkoły</th> <th>Piętro</th> <th>Pokój</th> <th>Lokalizacja urządzeń w szafie typu Rack</th> 
                <th>Typ urządzenia</th> <th>Producent urządzenia</th> <th>Model urządzenia</th> <th>Numer seryjny urządzenia</th> 
                <th>Part number urządzenia</th> <th>Data zakupu	urządzenia</th> <th>Gwarancja urządzenia</th> 
                <th>Numer inwentarzowy urządzenia</th><th>Nazwa sieciowa urządzenia</th><th>Awarie</th> 
                <th>Uwagi</th>
            </tr>
            <?php
                $href1 =  '<a class="href" href="szkoly.php">';
                $href2 = '</a>';
                $sql = "SELECT * FROM sieci_lan WHERE Szkoła_ID = '".$_SESSION['szkola_id']."'";
                ...
                if ($permissions["admin"] == true) {
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while($row = mysqli_fetch_assoc($result)) {
                            ...
                            "<td>".$row["Lokalizacja_urządzeń_w_szafie_typu_Rack"]."</td>"."<td>".$row["Typ_urządzenia"]."</td>"."<td>".$row["Producent_urządzenia"].
                            ...
                            "<td>".$row["Nazwa_sieciowa_urządzenia"]."</td>"."<td>".$row["Awarie"]."</td>".
                            "<td>".$row["Uwagi"]."</td>"."</tr>" ; 
                        }
                    } 
                    else {
